...
# Pluckability Zero-Shot Evaluation Script
# Tests GPT-5 and GPT-4.1 with zero-shot instruction (no temperature specified)

set -e  # Exit on any error

echo "🚀 Starting pluckability zero-shot evaluation runs..."
