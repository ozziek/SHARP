...
if __name__ == "__main__":
    ...
    sft_dataset = sft_dataset[args.split]
    if args.balance:
        sft_dataset = _balance_dataset(sft_dataset, seed=args.seed)
    sft_dataset = build_dataset(sft_dataset, base_instruction, args.exclude_completions)
